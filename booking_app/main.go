...
func main() {
	...
	switch city {
	case "New York":
		// excecute code for booking New York conference
	case "Singapour", "Hong Kong":
		// excecute code for booking Singapour or Hong Kong conference

	case "London", "Berlin":
		// excecute code for booking London or Berlin conference

	case "Mexico City":
		// excecute code for booking Mexico City conference
